 ...
 */
final class Version20251016063325 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user CHANGE email email VARCHAR(255) NOT NULL, CHANGE password password VARCHAR(100) NOT NULL, CHANGE roles roles VARCHAR(20) NOT NULL, CHANGE phone_number phone_number VARCHAR(200) NOT NULL, CHANGE address address LONGTEXT DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user CHANGE email email VARCHAR(180) NOT NULL, CHANGE password password VARCHAR(255) NOT NULL, CHANGE roles roles JSON NOT NULL, CHANGE phone_number phone_number VARCHAR(200) DEFAULT NULL, CHANGE address address TEXT DEFAULT NULL');
